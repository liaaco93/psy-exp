...
(function() {
  $(function() {
    return $('#experiments').trigger('click');
  });

  $('#tabMenu').on('click', '.item', function() {
    $('#tabMenu').children('.item').removeClass('active');
    $(this).addClass('active');
    return $("#tabContents").attr("src", $(this).attr('id') === 'experiments' ? '/static/html/admin-gui-exptable.html' : "/admin/view/" + ($(this).attr('eid')));
  });
